        <div class="grid_3">
            <div id="summary_box" class="sidebox">
                ...
                <div class="summary_item">
                    ...
                    <div class="sidebox_value">73,645 cals</div><br />
                    <div class="sidebox_label">Monthly Quota</div>
                    <div class="sidebox_value">10,000 cals</div><br />
                    <div class="sidebox_label">This Month</div>
                    <div class="sidebox_value">7,455 cals</div><br />
                    <div class="sidebox_label">Calories To Quota</div>
                    <div class="sidebox_value">2,545 cals</div><br />
                ...
                <div class="summary_item">
                    ...
                    <div class="sidebox_label">Total</div>
                    <div class="sidebox_value">64,830 cals</div><br />
                    <div class="sidebox_label">Monthly Quota</div>
                    <div class="sidebox_value">8,000 cals</div><br />
                    <div class="sidebox_label">This Month</div>
                    <div class="sidebox_value">6,100 cals</div><br />
                    <div class="sidebox_label">Calories To Quota</div>
                    <div class="sidebox_value">1,900 cals</div><br />
        ...
        <div class="grid_6">
            <div id="content_tabs">
                ...
                <div id="content_3" class="content">
                    ...
                    ridiculus mus. Vestibulum sodales felis dolor, id elementum arcu luctus
                    sollicitudin. Vivamus sed sapien nec sem dignissim ornare. Phasellus sit
                    amet nisl imperdiet, aliquet nibh sit amet, lobortis turpis. Vivamus sem
                    purus, eleifend malesuada justo vitae, vulputate viverra sapien. Aenean
                    hendrerit libero et tellus adipiscing, tincidunt convallis odio vulputate.
                    Nunc scelerisque dolor quis ligula scelerisque fermentum. Pellentesque non
                    tincidunt augue.
                </div>
                <div id="content_4" class="content">
                    Vivamus iaculis massa est. Donec hendrerit gravida risus ut ornare. Cras
                    quis luctus turpis. Integer volutpat lectus nibh. Pellentesque vestibulum
