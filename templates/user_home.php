        <div class="grid_6">
            <div id="content_tabs">
                <div id="content_tab_labels">
                    <label id="content_tab_1" class="" for="diet_content">Diet Entries</label>
                    <label id="content_tab_2" class="" for="exercise_content">Exercise Entries</label>
                    <label id="content_tab_3" class="active" for="diet_table_content">Diet Tables</label>
                    <label id="content_tab_4" class="" for="content_4">Tab Four</label>
                </div>
                <div id="diet_content" class="content">
                ...
                <div id="diet_table_content" class="content active">
                    Below is a list of tables showing your diet tendencies over the past 6 months.
                    <div id="diet_placeholder" style="border: 1px solid #ccc;width: 100%;height: 300px;"></div>
                </div>
